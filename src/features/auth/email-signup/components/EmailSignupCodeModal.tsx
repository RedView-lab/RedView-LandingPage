...
type EmailSignupCodeModalProps = {
  email: string;
  isOpen: boolean;
  code: string[];
...
export function EmailSignupCodeModal({
  email,
  isOpen,
  code,
  codeLengthLabel,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-10 sm:px-8" role="dialog" aria-modal="true" aria-labelledby="signup-email-code-title">
      <div className="absolute inset-0 bg-black/70 backdrop-blur-[8px]" onClick={onClose} />

      <div className="relative w-full max-w-[408px] overflow-hidden rounded-[12px] border border-white/8 bg-[rgba(255,255,255,0.07)] shadow-[0_20px_24px_-4px_rgba(10,13,18,0.08),0_8px_8px_-4px_rgba(10,13,18,0.03),0_3px_3px_-1.5px_rgba(10,13,18,0.04)]">
        <button
          type="button"
        ...
        <div className="flex flex-col items-center px-6 pt-6 text-center">
          ...
          <h2 id="signup-email-code-title" className="text-[18px] font-semibold leading-7 text-white">
        ...
        <div className="px-6 pb-6 pt-5">
          ...
          <div className="mt-8 flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="flex h-11 flex-1 items-center justify-center rounded-[8px] border border-white/16 bg-white/7 px-4 text-[16px] font-semibold text-white shadow-[0_1px_2px_rgba(10,13,18,0.05),inset_0_0_0_1px_rgba(10,13,18,0.18),inset_0_-2px_0_rgba(10,13,18,0.05)] transition hover:bg-white/10"
            >
              Cancel
            </button>
            <button
